...
# Run once after a fresh install to apply sensible defaults.
#
...
# Set timezone — uncomment and update to your timezone
# sudo systemsetup -settimezone "Europe/Lisbon" > /dev/null

# Set wallpaper
osascript -e "tell application \"Finder\" to set desktop picture to POSIX file \"$HOME/background/biker.jpg\"" 2>/dev/null || true
...
# Configure search result categories
